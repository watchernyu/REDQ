...
#SBATCH --array=0-5 # here the number depends on number of tasks in the array, e.g. 0-59 will create 60 tasks
...
python grid_train_redq_sac.py --setting ${SLURM_ARRAY_TASK_ID}